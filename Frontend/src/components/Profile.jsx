...
const Profile = () => {
  return (
    <>
      <div className="min-h-screen p-2 bg-gray-600 flex items-center justify-center show-box">
        ...
        <div className="container max-w-screen-lg mx-auto">
          <div>
            <div className="ml-5 mt-64 flex flex-wrap gap-2">
            ...
            <div className="ml-5 intro_sec d-block d-lg-flex align-items-center">
